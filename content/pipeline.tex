...
\multirow{5}{*}{ImbalancedDataGenerator} & class\_ratio & The ratio of
...
\multirow{3}{*}{Study} & data\_generator & Instance of the
...
\midrule()
\endhead
\multirow{2}{*}{ImbalancedDataGenerator} & generate\_data & Generates a
...
instance \\
\multirow{2}{*}{Classifier} & fit & Fits the classifier that was passed
...
\multirow{3}{*}{Study} & run & Creates an imbalanced dataset using the
